...
start "Portal :8080" cmd /k "python serve.py"
timeout /t 2 /nobreak >nul

echo  [2/3] Starting QC System on port 8001...
start "QC System :8001" cmd /k "cd /d "%~dp0QC\backend" && python manage.py runserver 0.0.0.0:8001"
timeout /t 2 /nobreak >nul

echo  [3/3] Starting Production System on port 8002...
start "Production System :8002" cmd /k "cd /d "%~dp0Production\backend" && python manage.py runserver 0.0.0.0:8002"
timeout /t 2 /nobreak >nul
