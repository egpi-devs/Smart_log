...
const App = {
    ...
    render() {
        ...
        if (api.isLoggedIn()) {
            ...
            const isManagerOrSuperuser = roles.includes('Manager') || roles.includes('Superuser');
            
            if (page === 'export' && !isManagerOrSuperuser) {
                App.toast('You do not have permission to access the Export Data page.', 'error');
                Router.navigate('dashboard');
                return;
            }
        }
