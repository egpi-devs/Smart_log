...
const FinishedProductsPage = {
    ...
    entryFields: [
        { key: 'date', label: 'Date & Time', type: 'datetime', default: '', readOnly: true },
        { key: 'material', label: 'Material Name', type: 'product-search', category: 'Finished', required: true },
        ...
        { key: 'manufacture_date', label: 'Manufacture Date', type: 'date', required: true },
