...
function renderSidebar(activePage) {
    ...
    const showExport = hasRole('Manager', 'Superuser');

    const showYearlyRaw = roleStartsWith('Section Head (RM)', 'Section Head (FP Micro)') || hasRole('Manager', 'Superuser');
    const showYearlyPkg = roleStartsWith('Section Head (PM)', 'Section Head (FP Micro)') || hasRole('Manager', 'Superuser');
    const showYearlyFin = roleStartsWith('Section Head (FP') || hasRole('Manager', 'Superuser');
    const showYearlyAny = showYearlyRaw || showYearlyPkg || showYearlyFin;
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                ${showExport ? `<div class="nav-item ${activePage === 'export' ? 'active' : ''}"
                ...
                <div class="nav-group-children ${activePage.startsWith('yearly') ? 'show' : ''}">
                    ${showYearlyRaw ? `<div class="nav-item ${activePage === 'yearly-raw' ? 'active' : ''}"
                         onclick="Router.navigate('yearly-raw')">
                        <i class="fas fa-file-alt"></i> Raw Materials
                    </div>` : ''}
                    ${showYearlyPkg ? `<div class="nav-item ${activePage === 'yearly-packaging' ? 'active' : ''}"
                         onclick="Router.navigate('yearly-packaging')">
                        <i class="fas fa-file-alt"></i> Packaging Materials
                    </div>` : ''}
                    ${showYearlyFin ? `<div class="nav-item ${activePage === 'yearly-finished' ? 'active' : ''}"
